...
exports.findAll = async (req, res, next) => {
    ...
    if(error) {
        return next(new BadRequestError(500, "An occurred while retrieving contacts"));
    }

    return res.send(document);
};

//Cai dat ham handler findOne
...
exports.update = async (req, res, next) => {
    ...
    const [error, document] = await handlePromise(Contact.findOneAndUpdate(condition, req.body, { new: true}));
